...
// Таблица posts
db.execute('CREATE TABLE IF NOT EXISTS `posts` (`id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,`parent` INT(10) UNSIGNED NULL DEFAULT NULL,`title` VARCHAR(120) NULL DEFAULT NULL,`active` TINYINT(1) UNSIGNED NULL DEFAULT "1",`users` VARCHAR(250) NOT NULL DEFAULT "",`stat_id` VARCHAR(250) NOT NULL DEFAULT "",PRIMARY KEY (`id`),INDEX `parent` (`parent`))COLLATE="utf8_general_ci"ENGINE=InnoDB;')

// Таблица stats
db.execute('CREATE TABLE IF NOT EXISTS `stats` (`id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,`title` VARCHAR(120) NULL DEFAULT NULL,	`description` TEXT NULL,`reverted` TINYINT(2) UNSIGNED NOT NULL DEFAULT "0",`active` TINYINT(2) UNSIGNED NULL DEFAULT "1",`stat_data` JSON NULL DEFAULT NULL,`last_day` TINYINT(1) UNSIGNED NULL DEFAULT "3",`sort` INT(10) UNSIGNED NULL DEFAULT NULL,PRIMARY KEY (`id`),INDEX`reverted` (`reverted`))COLLATE="utf8_general_ci"ENGINE=InnoDB;')
